...
<div class="row g-0">
    ...
    <div class="card mb-3">
        <div class="card-header bg-light">
            <h5 class="mb-0">Biến động số dư</h5>
        </div>
        <div class="card-body">
                ...
                <div class="table-responsive scrollbar">
                    ...
                    ?>
                            <tr>
                                ...
                                <td class="history_buy_point_original">
                                    <?=number_format($row['history_buy_point_original']);?></td>
                                <td class="history_buy_point_final"><?=number_format($row['history_buy_point_final']);?>
                                </td>
