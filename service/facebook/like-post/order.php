            ...
            <div class="card-header bg-light">
                <div class="row justify-content-between">
                    ...
                    <div class="col-md-auto"><a class="btn btn-falcon-primary btn-sm"
                            href="/service/facebook/like-post/list"><span class="fas fa-list fs--2 mr-1"></span> Danh
                            sách
                            đơn</a>
                    </div>
                </div>
            ...
            <div class="card-body bg-light">
                ...
                <form action="" id="form_id" class="user" method="POST" accept-charset="utf-8">
                    <div class="mb-3">
                        ...
                        <label>(*) Nếu nhập <code>Link bài viết</code> hệ thống sẽ tự động <code>Get ID bài viết</code>
                        </label>
                    </div>
                    <div class="mb-3">
                        <label>Máy chủ:</label>
                        ...
                        <?php } ?>
                        <div class="alert alert-warning alert-dismissible fade show fs--1" role="alert"> - Tất cả máy chủ đều không có bảo hành. <br> - Nên buff dư cho khách tránh tụt nhé!. </div>
                    </div>
                    <div class="mb-3">
                        <label>Cảm xúc:</label>
                        <div class="col-md-12">
                            <div class="text-center py-3 pt-3">
                                <div class="form-check form-check-inline">
                                    <label class="form-check-label " for="buff_reaction">
                                        <input class="form-check-input checkbox d-none" type="radio" data-prices="101"
                                            id="buff_reaction" name="buff_reaction" value="like" checked=""><img
                                            src="/assets/img/fb-reaction/like.png" alt="image"
                                            class="d-block ml-2 rounded-circle" width="50">
                                    </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <label class="form-check-label " for="buff_reaction_1">
                                        <input class="form-check-input checkbox d-none" type="radio" data-prices="100"
                                            id="buff_reaction_1" name="buff_reaction" value="love"><img
                                            src="/assets/img/fb-reaction/love.png" alt="image"
                                            class="d-block ml-2 rounded-circle" width="50">
                                    </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <label class="form-check-label " for="buff_reaction_2">
                                        <input class="form-check-input checkbox d-none" type="radio" data-prices="100"
                                            id="buff_reaction_2" name="buff_reaction" value="care"><img
                                            src="/assets/img/fb-reaction/care.png" alt="image"
                                            class="d-block ml-2 rounded-circle" width="50">
                                    </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <label class="form-check-label " for="buff_reaction_3">
                                        <input class="form-check-input checkbox d-none" type="radio" data-prices="100"
                                            id="buff_reaction_3" name="buff_reaction" value="haha"><img
                                            src="/assets/img/fb-reaction/haha.png" alt="image"
                                            class="d-block ml-2 rounded-circle" width="50">
                                    </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <label class="form-check-label " for="buff_reaction_4">
                                        <input class="form-check-input checkbox d-none" type="radio" data-prices="100"
                                            id="buff_reaction_4" name="buff_reaction" value="wow"><img
                                            src="/assets/img/fb-reaction/wow.png" alt="image"
                                            class="d-block ml-2 rounded-circle" width="50">
                                    </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <label class="form-check-label " for="buff_reaction_5">
                                        <input class="form-check-input checkbox d-none" type="radio" data-prices="100"
                                            id="buff_reaction_5" name="buff_reaction" value="sad"><img
                                            src="/assets/img/fb-reaction/sad.png" alt="image"
                                            class="d-block ml-2 rounded-circle" width="50">
                                    </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <label class="form-check-label " for="buff_reaction_6">
                                        <input class="form-check-input checkbox d-none" type="radio" data-prices="100"
                                            id="buff_reaction_6" name="buff_reaction" value="angry"><img
                                            src="/assets/img/fb-reaction/angry.png" alt="image"
                                            class="d-block ml-2 rounded-circle" width="50">
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="mb-3">
                        <label>Tốc độ:</label>
                        <div class="form-check">
                            <input class="form-check-input" id="buff_speed" type="radio" onchange="bill();"
                                name="buff_speed" value="fast" data-bs-toggle="collapse" checked="" />
                            <label class="form-check-label" for="buff_speed">Nhanh (lên nhanh thì sẽ bị nhanh tụt
                                nhé.)</label>

                        </div>
                        <div class="form-check">
                            <input class="form-check-input" id="buff_speed_1" type="radio" onchange="bill();"
                                name="buff_speed" value="slow" data-bs-toggle="collapse" />
                            <label class="form-check-label" for="buff_speed_1">Chậm (nên chọn cho ổn định, sẽ không
...
function buy_service() {
    ...
    var buff_reaction = $('input[name=buff_reaction]:checked').val();
    var buff_speed = $('input[name=buff_speed]:checked').val();
    ...
    if (!buff_reaction) {
        swal('Trường cảm xúc không được bỏ trống.', 'error');
        return;
    }
    if (!buff_speed) {
        swal('Trường tốc độ không được bỏ trống.', 'error');
        return;
    }
    if (!buff_amount) {
    ...
    $.ajax({
        url: WEBSITE_URL + prefix + 'service/facebook/like-post/order.php',
        type: 'POST',
        dataType: 'JSON',
        data: {
