            ...
            <div class="card-header bg-light">
                <div class="row justify-content-between">
                    ...
                    <div class="col-md-auto"><a class="btn btn-falcon-primary btn-sm"
                            href="/service/facebook/follow-sale/list"><span class="fas fa-list fs--2 mr-1"></span> Danh
                            sách
                            đơn</a>
                    </div>
                </div>
            ...
            <div class="card-body bg-light">
                ...
                <form action="" id="form_id" class="user" method="POST" accept-charset="utf-8">
                    ...
                    <div class="mb-3">
                        ...
                        <?php } ?>
                        <div class="alert alert-warning alert-dismissible fade show fs--1" role="alert"> - Sv1 tăng từ 3k -&gt; 15k/ 1 ngày tốc độ ổn định, nhanh hơn với đơn to (tùy vào sub gốc). <br> - Sv2 tăng từ 300 -&gt; 5k/ 1 ngày tốc độ chậm, nhanh hơn với đơn to (tùy vào sub gốc). <br> - Sv3 tăng từ 50k -&gt; 100k/ 1 ngày tốc độ cực nhanh, đơn càng to càng nhanh (tùy vào sub gốc). <br> - Sau khi mua sub sẽ lên sau 10p -&gt; 1h. <br> - Loại sub này có bảo hành thì chỉ bảo hành khi tụt trên 70%. <br> - Nên buff dư cho khách tránh tụt nhé!. </div>
                    </div>
                    <div class="mb-3">
...
function buy_service() {
    ...
    $.ajax({
        url: WEBSITE_URL + prefix + 'service/facebook/follow-sale/order.php',
        type: 'POST',
        dataType: 'JSON',
        data: {
