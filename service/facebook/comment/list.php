    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <div id="tableExample2"
                data-list='{"valueNames":["buff_id","buff_time","buff_code","buff_fb_id","buff_comment","buff_note","buff_present","buff_payment","buff_status"],"page":10,"pagination":true}'>
                <div class="mb-3">
                    ...
                    <table class="table table-bordered table-striped fs--1 mb-0">
                        ...
                        <tbody class="list">
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                $urlCreateService        = 'https://automxh.vn/api/service/facebook/comment-sale/list';
