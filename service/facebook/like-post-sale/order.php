        ...
        <div class="card h-lg-100 overflow-hidden">
            <div class="card-header bg-light">
                <div class="row justify-content-between">
                    ...
                    <div class="col-md-auto"><a class="btn btn-falcon-primary btn-sm"
                            href="/service/facebook/like-post-sale/list"><span class="fas fa-list fs--2 mr-1"></span>
                            Danh sách
                            đơn</a>
                    </div>
                </div>
            ...
            <div class="card-body bg-light">
                ...
                <form action="" id="form_id" class="user" method="POST" accept-charset="utf-8">
                    <div class="mb-3">
                        <label>Nhập Link bài viết cần tăng:</label>
                    ...
                    <div class="mb-3">
                        ...
                        <?php } ?>
                        <div class="alert alert-warning alert-dismissible fade show fs--1" role="alert"> - Loại like này max 250k. <br> - Hãy lấy link bài viết trên Pc để tránh lỗi nhé!. <br> - Loại like này lên chậm do nhiều đơn to và có thể thiếu. <br> - Loại like này không có bảo hành. <br> - Nên buff dư cho khách tránh tụt nhé!. </div>
                    </div>
                    <div class="mb-3">
...
function buy_service() {
    ...
    $.ajax({
        url: WEBSITE_URL + prefix + 'service/facebook/like-post-sale/order.php',
        type: 'POST',
        dataType: 'JSON',
        data: {
