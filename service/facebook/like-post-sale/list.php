...
$result = mysqli_query($conn,"SELECT * FROM table_service WHERE service_slug = 'buff-like-post-sale-facebook'");
    ...
    <div class="card mb-3">
        <div class="card-header bg-light">
            <div class="row justify-content-between">
                ...
                <div class="col-md-auto"><a class="btn btn-falcon-primary btn-sm"
                        href="/service/facebook/like-post-sale/order"><span class="fas fa-plus fs--2 mr-1"></span> Thêm
                        đơn</a>
                </div>
            </div>
        </div>
        <div class="card-body">
            <div id="tableExample2"
                data-list='{"valueNames":["buff_id","buff_time","buff_code","buff_fb_id","buff_amount","buff_note","buff_present","buff_payment","buff_status"],"page":10,"pagination":true}'>
                <div class="mb-3">
                ...
                <div class="table-responsive scrollbar">
                    <table class="table table-bordered table-striped fs--1 mb-0">
                        ...
                        <tbody class="list">
                            <?php 
                            $result = mysqli_query($conn, "SELECT * FROM table_buff WHERE buff_username = '$user_username' AND buff_slug = 'buff-like-post-sale-facebook' ORDER BY buff_id DESC LIMIT 0,15");
                            while ($row = mysqli_fetch_assoc($result)) {
                                $urlCreateService        = 'https://automxh.vn/api/service/facebook/like-post-sale/list';
                            ...
                            <tr>
                                ...
                                <td class="buff_fb_id"><a class="text-primary" href="<?=$row['buff_fb_id'];?>"
                                        target="_blank">Link bài viết</a>
                                </td>
