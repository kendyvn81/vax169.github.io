            ...
            <div class="card-header bg-light">
                <div class="row justify-content-between">
                    ...
                    <div class="col-md-auto"><a class="btn btn-falcon-primary btn-sm"
                            href="/service/facebook/eye-live/list"><span class="fas fa-list fs--2 mr-1"></span> Danh
                            sách
                            đơn</a>
                    </div>
                </div>
            ...
            <div class="card-body bg-light">
                ...
                <form action="" id="form_id" class="user" method="POST" accept-charset="utf-8">
                    ...
                    <div class="mb-3">
                        ...
                        <?php } ?>
                        <div class="alert alert-warning alert-dismissible fade show fs--1" role="alert"> - Hệ thống sẽ tăng từ 90% - 120% số mắt đã cài (Máy chủ VIP) <br> - Hệ thống sẽ tăng từ 80% - 120% số mắt đã cài (Máy chủ thường) <br> - Hệ thống sẽ tăng từ 70% - 120% số mắt đã cài (Máy chủ rẻ) <br> - Hệ thống sẽ tăng từ 60% - 120% số mắt đã cài (Máy chủ cực rẻ) <br> - Không chạy livestream chia sẻ âm nhạc <br> - Nên buff dư cho khách tránh tụt nhé!. </div>
                    </div>
                    <div class="mb-3">
                        <label>Số mắt:</label>
                    ...
                    <div class="mb-3">
                        <label>Số phút:</label>
                        <input type="number" id="buff_minutes" name="minutes" onkeyup="bill();"
                            class="form-control mb-3" placeholder="Nhập số phút cần tăng" required="">
                        <div class="alert alert-warning alert-dismissible fade show fs--1 text-center" role="alert">
                            Tổng tiền = (Số lượng) x (Số phút) x (Giá 1 mắt) </div>
                    </div>
                    <div class="mb-3">
                        <label>Ghi chú:</label>
...
function buy_service() {
    ...
    $.ajax({
        url: WEBSITE_URL + prefix + 'service/facebook/eye-live/order.php',
        type: 'POST',
        dataType: 'JSON',
        data: {
