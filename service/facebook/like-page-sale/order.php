            ...
            <div class="card-header bg-light">
                <div class="row justify-content-between">
                    ...
                    <div class="col-md-auto"><a class="btn btn-falcon-primary btn-sm"
                            href="/service/facebook/like-page-sale/list"><span class="fas fa-list fs--2 mr-1"></span>
                            Danh sách
                            đơn</a>
                    </div>
                </div>
            ...
            <div class="card-body bg-light">
                ...
                <form action="" id="form_id" class="user" method="POST" accept-charset="utf-8">
                    ...
                    <div class="mb-3">
                        ...
                        <?php } ?>
                        <div class="alert alert-warning alert-dismissible fade show fs--1" role="alert"> - Sv1 tăng từ 3k -&gt; 15k/ 1 ngày (tùy vào like gốc). <br> - Sv2 tăng từ 300 -&gt; 1k/ 1 ngày (tùy vào like gốc). <br> - Loại like này không bảo hành. <br> - Nên buff dư cho khách tránh tụt nhé!. </div>
                    </div>
                    <div class="mb-3">
...
function buy_service() {
    ...
    $.ajax({
        url: WEBSITE_URL + prefix + 'service/facebook/like-page-sale/order.php',
        type: 'POST',
        dataType: 'JSON',
        data: {
