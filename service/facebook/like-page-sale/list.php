...
$result = mysqli_query($conn,"SELECT * FROM table_service WHERE service_slug = 'buff-like-page-sale-facebook'");
        ...
        <div class="card-header bg-light">
            <div class="row justify-content-between">
                ...
                <div class="col-md-auto"><a class="btn btn-falcon-primary btn-sm"
                        href="/service/facebook/like-page-sale/order"><span class="fas fa-plus fs--2 mr-1"></span> Thêm đơn</a>
                </div>
            </div>
        </div>
        <div class="card-body">
            <div id="tableExample2"
                ...
                <div class="table-responsive scrollbar">
                    <table class="table table-bordered table-striped fs--1 mb-0">
                        ...
                        <tbody class="list">
                            <?php 
                            $result = mysqli_query($conn, "SELECT * FROM table_buff WHERE buff_username = '$user_username' AND buff_slug = 'buff-like-page-sale-facebook' ORDER BY buff_id DESC LIMIT 0,15");
                            while ($row = mysqli_fetch_assoc($result)) {
                                $urlCreateService        = 'https://automxh.vn/api/service/facebook/like-page-sale/list';
